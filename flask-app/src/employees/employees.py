...
@employees.route('/tenMostExpensive', methods=['GET'])
...
def add_new_employee():
    ...
    query = 'insert into HuskyEatzEmployee (FirstName, LastName, Role) values ("'
    query += name + '", "'
    query += description + '", "'
    query += category + '", '
    query += str(price) + ')'
...
@employees.route('/categories', methods = ['GET'])
